...
public class CustomerDAO extends DataAccessObject<Customer> {
    ...
    public Customer findById(long id) {
        ...
        try (PreparedStatement statement = this.connection.prepareStatement(GET_ONE)) {
            ...
            logger.error("Unable to create a prepared statement", ex);
    ...
    public Customer update(Customer dto) {
        ...
        try (PreparedStatement statement = this.connection.prepareStatement(UPDATE)) {
            ...
            logger.error("Unable to create prepared statement to update customer", ex);
            throw new RuntimeException(ex);
        }
    ...
    public void delete(long id) {
        try (PreparedStatement statement = this.connection.prepareStatement(DELETE)) {
            ...
            logger.error("Unable to create a prepared statement for delete operation", ex);
            throw new RuntimeException(ex);
        }
    }
    ...
    public List<Customer> findAllSorted(int limit) {
        ...
        try (PreparedStatement statement = this.connection.prepareStatement(GET_ALL_LIMIT)) {
            ...
            logger.error("An error occurred when getting the list of sorted customers", ex);
        }
