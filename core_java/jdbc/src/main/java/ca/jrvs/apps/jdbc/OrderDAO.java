...
public class OrderDAO extends DataAccessObject<Order> {
    private static final String GET_ONE = "SELECT c.first_name, c.last_name, c.email, o.order_id, o.creation_date, " +
    ...
    public Order findById(long id) {
        ...
        try (PreparedStatement statement = this.connection.prepareStatement(GET_ONE)) {
            ...
            logger.error("Unable to crete prepared statement for find operation", ex);
    ...
    public List<Order> getOrdersForCustomer(long id) {
        ...
        try (PreparedStatement statement = this.connection.prepareStatement(GET_FOR_CUSTOMER)) {
            statement.setLong(1, id);
            ResultSet resultSet = statement.executeQuery();
            long orderId = 0;
            Order order = null;
            ...
            logger.error("An error occurred while creating a prepared statement for the procedure", ex);
            throw new RuntimeException(ex);
        }
